      ...
      <div class="go-mr-3">
        <div>
          <setting-item-box name="主体信息">
            <setting-item name="频道">
              <n-input size="small" :placeholder="globalData?.subscribeChannel || '暂无'" :disabled="true"> </n-input>
            </setting-item>
            <setting-item name="过滤值">
              <n-input size="small" :placeholder="`${socketFilterValue || '暂无'}`" :disabled="true">
                <template #suffix>
          ...
          <setting-item-box name="频道" :alone="true">
            <n-input size="small" :placeholder="globalData?.subscribeChannel || '暂无'" :disabled="true">
              <template #prefix>
...
const { requestInterval, requestParams, requestIntervalUnit, socketFilterKey, socketFilterValue } = toRefs(
