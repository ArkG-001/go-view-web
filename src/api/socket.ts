...
export const socket = io('ws://192.168.1.230:9200')

export const setupSocket = () => {
  socket.on('connect', () => {
    console.log('连接成功--=33333')
    // 订阅频道：clientuuid
    // socket.emit('subscribe', '92210311119')
 ...
 */
export const customizeSocket = (targetParams: RequestConfigType, globalParams: RequestGlobalConfigType) => {
