<template>
  ...
  <CollapseItem name="样式" expanded>
    ...
    <SettingItemBox name="方向" alone>
      <SettingItem>
        <n-button size="small" @click="optionData.direction = 'up'"> 向上 </n-button>
        <n-button size="small" @click="optionData.direction = 'down'"> 向下 </n-button>
      </SettingItem>
    </SettingItemBox>
  </CollapseItem>
</template>
